...
import { Asistente, ListAsistentes, ListMember, MemberResponse, Members, Miembro, Visita } from '../interfaces/miembro-admin.interface';
...
export class MiembrosService {
  ...
  public _members = signal<Members | null>(null);
  ...
  getAllMembers(page: number, term: string): Observable<Boolean> 
  {
    ...
    return this.http.get<ListMember>(url, {headers})
    .pipe(
      map(({ status, members }) => {
