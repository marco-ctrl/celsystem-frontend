...
import { Asistente, Miembro, Visita } from '../../../../admin/interfaces/miembro-admin.interface';
...
import { QrImageService } from '../../../../admin/services/qrImage.service';
import { InformeAppService } from '../../../services/informe-app.service';
...
import { ImageModalComponent } from '../../../../admin/pages/qr/image_modal/image_modal.component';
...
export default class FormInformeComponent {
  ...
  private informeService = inject(InformeAppService);
    ...
    this.informeService.addInforme(informeForm).subscribe(
      {
        next: () => {
          ...
          if (this.informeService.status()) {
            ...
            this.router.navigateByUrl('app/informe');
          }
          else {
            Swal.fire({
              icon: "error",
